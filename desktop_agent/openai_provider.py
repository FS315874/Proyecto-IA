...
def _classification_instructions() -> str:
    ...
    return (
        ...
        "video actual. RESUME_YOUTUBE usa target null para reanudar, continuar o "
        "poner play al video actual. Nunca conviertas un control del video actual "
        "en una consulta de búsqueda. "
        "Si piden abrir YouTube y reproducir algo, basta PLAY_YOUTUBE. "
        "Para Spotify, PLAY_SPOTIFY_TRACK usa target como canción o canción y artista; "
        "PLAY_SPOTIFY_PLAYLIST usa sólo el nombre de la playlist del usuario; "
        "SEARCH_SPOTIFY_TRACK busca y muestra el primer resultado sin reproducirlo. "
        "PAUSE_SPOTIFY, RESUME_SPOTIFY, NEXT_SPOTIFY y PREVIOUS_SPOTIFY usan target null "
